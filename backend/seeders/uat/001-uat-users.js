...
/**
 * User Acceptance Testing (UAT) seed file for users
 * Creates a set of test users with different roles for UAT environment
 * File: 001-uat-users.js (runs first in the seeding sequence)
 */
module.exports = {
  up: async (queryInterface, Sequelize) => {
    const salt = await bcrypt.genSalt(10);
    const hashedPassword = await bcrypt.hash('UAT_Staging2025!', salt);
